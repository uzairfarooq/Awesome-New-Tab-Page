...
//   var toRet = new Array();
//   var closestElm = findClosest(tile);
//   var thisTop = $(closestElm).position().top;
//   var thisLeft = $(closestElm).position().left;
//   var numCol = $(tile).attr("data-tile-width");
//   var numRow = $(tile).attr("data-tile-height");
//   var correctCol = 0;
//   var correctRow = 0;
//   var numMove = 0;
//   //get ones to right of top left
//   $(".tile").each(function(ind, elem){
//       if(correctCol >= numCol){
//         return false;
//       }
//       if($(elem).position().left >= thisLeft && $(elem).position().top == thisTop){
//         toRet.push(elem);
//         correctCol++;
//       }
//   });
//   //get tiles below top left
//   $(".tile").each(function(ind, elem){
//       if($(elem).position().top >= thisTop && $(elem).position().left == thisLeft){
//         correctRow++;
//         toRet.push(elem);
//       }
      
//       if(correctRow >= numRow){
//         return false;
//       }
//   });
//   //get tiles inbetween top row and left column
//   var numBetween = (correctCol - 1) * (correctRow - 1);
//   var correctBetween = 0;
//   $(".tile").each(function(ind, elem){
//       if($(elem).position().left - 206 >= thisLeft && $(elem).position().top - 206 >= thisTop){
//         correctBetween++;
//         toRet.push(elem);
//       }
//       if(correctBetween >= numBetween){ //if we have found all the ones inbetween then break off
//         return false;
//       }
//   });
//   return toRet;
...
// function checkClear(tile){
//   var toRet = new Array();
//   var closestElm = findClosest(tile);
//   if(!$(closestElm).hasClass("empty")){
//     return false;
//   }else if($(closestElm).hasClass("empty") && $(tile).attr("data-tile-width") == 1 && $(tile).attr("data-tile-height") == 1){
//     toRet[0] = closestElm;
//     return toRet;
//   }else{
//     var thisTop = $(closestElm).position().top;
...
//     var correctCol = 0;
//     var correctRow = 0;
//     //check ones to right of top left
//     $(".tile").each(function(ind, elem){
//         if($(elem).position().left >= thisLeft && $(elem).position().top == thisTop){
          
//           if(!$(elem).hasClass("empty")){ //if this square is not empty
//             return false;
//           }
//           toRet.push(elem);
//           correctCol++;
...
//     //check tiles inbetween top row and left column
//     var numBetween = (correctCol - 1) * (correctRow - 1);
//     var correctBetween = 0;
//     $(".tile").each(function(ind, elem){
//         if($(elem).position().left - 203 >= thisLeft && $(elem).position().top - 203 >= thisTop){
//           if(!$(elem).hasClass("empty")){ //if we check an empty one that is inside break off early
//             return false;
//           }
//           correctBetween++;
//           toRet.push(elem);
